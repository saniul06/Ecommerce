...
<head>
    ...
    <link href="<?php echo e(asset('public/backend')); ?>/lib/medium-editor/medium-editor.css" rel="stylesheet">
    <link href="<?php echo e(asset('public/backend')); ?>/lib/medium-editor/default.css" rel="stylesheet">
...
<body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="<?php echo e(url('/')); ?>" target="_blank"><i class="icon ion-android-star-outline"></i>
            starlight</a></div>
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="sl-menu-link <?php echo $__env->yieldContent('dashboard'); ?>">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
                    <span class="menu-item-label">Dashboard</span>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <a href="<?php echo e(url('/')); ?>" class="sl-menu-link" target="_blank">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
                    <span class="menu-item-label">Visit site</span>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <a href="<?php echo e(route('admin.category')); ?>" class="sl-menu-link <?php echo $__env->yieldContent('category'); ?>"">
                <div class=" sl-menu-item">
                <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
                <span class="menu-item-label">Category</span>
        </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="#" class="sl-menu-link <?php echo $__env->yieldContent('service'); ?>">
            <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="<?php echo e(route('service.add')); ?>" class="nav-link <?php echo $__env->yieldContent('add-service'); ?>">Add
                    service</a></li>
            <li class="nav-item"><a href="<?php echo e(route('service.manage')); ?>" class="nav-link <?php echo $__env->yieldContent('manage-service'); ?>">Manage services</a></li>
        </ul>
        <a href="#" class="sl-menu-link <?php echo $__env->yieldContent('order'); ?>">
            <div class="sl-menu-item">
                <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
        ...
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="<?php echo e(route('order.all')); ?>" class="nav-link <?php echo $__env->yieldContent('all-order'); ?>">All Orders</a></li>
            <li class="nav-item"><a href="<?php echo e(route('service.manage')); ?>" class="nav-link <?php echo $__env->yieldContent('manage-service'); ?>">Manage services</a></li>
        </ul>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-header wd-200">
                        <ul class="list-unstyled user-profile-nav">
                            <li><a href="<?php echo e(route('edit.profile')); ?>"><i class="icon ion-ios-person-outline"></i> Edit Profile</a></li>
    ...
    <script src="<?php echo e(asset('public/backend')); ?>/js/ajax-backend.js"></script>
...
<?php /**PATH /opt/lampp/htdocs/nn/resources/views/admin/admin-master.blade.php ENDPATH**/ ?>