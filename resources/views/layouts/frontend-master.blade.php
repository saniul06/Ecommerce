...
<body>
            ...
            <ul>
                ...
                <li><a href="#">Pages</a>
                    <ul class="header__menu__dropdown">
                        ...
                        <li><a href={{ route('cart-page') }}>Shoping Cart</a></li>
                    </ul>
                </li>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            @if (Auth::guest())
                                ...
                                <div class="header__top__right__auth">
                                    <a href="{{ route('seller') }}"><i class="fa fa-user"></i> Be a seller</a>
                                </div>
                            @endif
                            ...
                            @if (Auth::check())
                                ...
                                <div class="d">
                                    <button class="b">Welcome {{ Auth::user()->name }}</button>
                                    <div class="t">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        ...
                        @endphp
                        <ul>
                            <li><a href="{{ route('cart-page') }}"><i class="fa fa-shopping-bag"></i> <span
                                        id='quantity'>{{ $quantity }}</span></a></li>
                        </ul>
                        <div class="header__cart__price" style="font-size:16px">Total: <span
                                id="amount">${{ $total }}</span></div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            ...
                            @endphp
                            @foreach ($cat as $item)
                                <li><a href="{{ route('category.page', $item->id) }}">{{ $item->category_name }}</a>
                                </li>
                            @endforeach
    ...
    <script src="{{ asset('public/frontend') }}/js/ajax-frontend.js"></script>
