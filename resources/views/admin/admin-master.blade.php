...
<body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="{{ url('/') }}" target="_blank"><i class="icon ion-android-star-outline"></i>
            starlight</a></div>
    <div class="sl-sideleft">
        ...
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('service.add') }}" class="nav-link @yield('add-service')">Add
                    service</a></li>
            <li class="nav-item"><a href="{{ route('service.manage') }}" class="nav-link @yield('manage-service')">Manage services</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('order.all') }}" class="nav-link @yield('all-order')">All Orders</a></li>
        </ul>
            ...
            <nav class="nav">
                <div class="dropdown">
                    <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                        ...
                        {{-- <img src="../img/img3.jpg" class="wd-32 rounded-circle"
                            alt=""> --}}
                    </a>
            ...
            <div class="tab-pane pos-absolute a-0 mg-t-60 active" id="messages" role="tabpanel">
                <div class="media-list">
                    ...
                    <a href="" class="media-list-link">
                        <div class="media">
                            {{-- <img src="../img/img3.jpg" class="wd-40 rounded-circle"
                                alt=""> --}}
                    ...
                    <a href="" class="media-list-link">
                        <div class="media">
                            {{-- <img src="../img/img4.jpg" class="wd-40 rounded-circle"
                                alt=""> --}}
                            <div class="media-body">
                    ...
                    <a href="" class="media-list-link">
                        <div class="media">
                            {{-- <img src="../img/img7.jpg" class="wd-40 rounded-circle"
                                alt=""> --}}
                            <div class="media-body">
                    ...
                    <a href="" class="media-list-link">
                        <div class="media">
                            {{-- <img src="../img/img5.jpg" class="wd-40 rounded-circle"
                                alt=""> --}}
                            <div class="media-body">
                ...
                <div class="media-list">
                    ...
                    <a href="" class="media-list-link read">
                        <div class="media pd-x-20 pd-y-15">
                            {{-- <img src="../img/img8.jpg" class="wd-40 rounded-circle"
                                alt=""> --}}
                            <div class="media-body">
                    ...
                    <a href="" class="media-list-link read">
                        <div class="media pd-x-20 pd-y-15">
                            {{-- <img src="../img/img9.jpg" class="wd-40 rounded-circle"
                                alt=""> --}}
                            <div class="media-body">
                    ...
                    <a href="" class="media-list-link read">
                        <div class="media pd-x-20 pd-y-15">
                            {{-- <img src="../img/img10.jpg" class="wd-40 rounded-circle"
                                alt=""> --}}
                            <div class="media-body">
    ...
    <script src="{{ asset('public/backend') }}/js/ajax-backend.js"></script>
